...
struct RecipeDetailView: View {
            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 20) {
                    ...
                    HStack(spacing: 0) {
                        ...
                        statCell("\(recipe.servings)", label: "Servings", color: .white.opacity(0.3))
                    }
                    .padding(12)
                    .background(
    ...
    private var miraTip: String {
        if recipe.nauseaSafe {
            return "This recipe is gentle on the stomach. Good choice for days when nausea is higher."
        }
        if recipe.protein >= 40 {
            return "High protein meal. This alone covers about 30% of your daily target."
        }
        return "Solid choice for your plan. Pair with a high-protein snack to stay on track."
    }
}
